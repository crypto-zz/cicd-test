...
/**
 * @title MetaLend's CErc721MainchainProxy Contract
 * @notice Proxies to CErc721Mainchain implementation
 * @author MetaLend
 */
contract CErc721MainchainProxy is CErc721MainchainStorage, CProxyInterface {
    /**
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "CErc721MainchainProxy::_setImplementation: Caller must be admin");
